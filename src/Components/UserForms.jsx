...
const emailMessage = (email) => {
  if (!email) return "";
  if (!email.includes("@")) return "No se encuentra el caracter @";
  if (!/@.+/.test(email)) return "Debe haber algo luego del caracter @";
  if (!/.+@/.test(email)) return "Debe haber algo antes del caracter @";
  return "";
};

const usernameMessage = (username) => {
  if (!username) return "";
  if (/^\d+$/.test(username)) return "No pueden ser solo caracteres númericos";
  return "";
};
...
const Login = (props = {}) => {
  ...
  return (
    <div className="user-forms__login">
        ...
        <div className="user-forms__footer">
          <div className="user-forms__options">
            {close && (
              <button
                type="button"
                className="user-forms__button user-forms__button--secondary"
                onClick={close}
              >
                Cerrar
              </button>
            ...
            <button
              type="submit"
              className="user-forms__button user-forms__button--primary"
              disabled={disabled}
            >
              Enviar
            </button>
...
const Signup = (props = {}) => {
  ...
  return (
    <div className="user-forms__signup">
      <form onSubmit={handleSubmit} action="" className="user-forms__form">
        <div className="user-forms__header">
